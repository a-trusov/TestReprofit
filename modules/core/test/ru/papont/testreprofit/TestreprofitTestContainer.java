package ru.papont.testreprofit;
...
public class TestreprofitTestContainer extends TestContainer {

    public TestreprofitTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/papont/testreprofit/app.properties",
    ...
    public static class Common extends TestreprofitTestContainer {

        public static final TestreprofitTestContainer.Common INSTANCE = new TestreprofitTestContainer.Common();
